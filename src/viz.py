...
def plot_colored_graph(G: nx.Graph, node_color_attr=None, edge_color_attr=None, edge_width_factor=None, pos=None, figsize=(20, 20),
					   node_cmap=plt.cm.plasma, edge_cmap=plt.cm.viridis, node_ticks=None, edge_ticks=None, node_size=300):
	...
	nc = nx.draw_networkx_nodes(G, pos, node_color=node_colors, cmap=node_cmap, node_size=node_size)
